...
class MainViewController: UITableViewController {
    ...
    lazy var controllers: [UIViewController.Type] = {
        return [ViewController.self, TestTimeScaleView.self, MetalViewController.self, TestTrackView2.self, MetalImageViewController.self, LottieToGif.self, MetalOfflineRenderTestController.self]
    }()
